...
function M.setup()
  ...
  incline.setup({
    ...
    render = function(props)
      ...
      local filename_hl =
        diagnostic_level == vim.diagnostic.severity.HINT and "DiagnosticHint"
      ...
      local modified_component =
        modified and { " ● ", guifg = "#9ccfd8", guibg = "NONE" } or ""
...
-- run immediately (since you're auto-loading)
M.setup()
